...
def count_chinese_chars_in_file(path: Path, encoding: str = "utf-8") -> int:
    return count_chinese_chars(path.read_text(encoding=encoding))
...
def main() -> int:
    ...
    parser.add_argument("--encoding", type=str, default="utf-8", help="Input encoding")
