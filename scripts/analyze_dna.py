...
SCENE_TYPE_KEYWORDS = {
    ...
    "training":    ["练习", "修行", "闭关", "磨炼", "演练", "试招", "领悟", "打坐", "训练", "巩固"],
    "romance":     ["心动", "脸红", "牵手", "拥抱", "暧昧", "喜欢", "亲近", "告白", "吃醋", "温柔"],
    "mystery":     ["线索", "调查", "追查", "可疑", "谜团", "推测", "案发", "证据", "试探", "布局"],
    "power_up":    ["晋升", "进阶", "蜕变", "觉醒", "突破瓶颈", "吸收", "传承", "升阶", "强化", "质变"],
    "chase":       ["追击", "逃跑", "追杀", "围堵", "拦截", "急奔", "脱身", "甩开", "追上", "遁走"],
    "crowd_reaction": ["围观", "议论", "众人", "传言", "议纷纷", "目光", "众生", "旁观", "评价", "轰动"],
    "strategy":    ["布局", "计划", "阴谋", "谋划", "暗算", "设局", "精心", "算计", "圈套", "棋局"],
    "flashback":   ["回忆", "记得", "当年", "很久前", "曾经", "从前", "回想", "往事", "过去", "当时"],
    "world_building": ["介绍", "说明", "据说", "相传", "规则", "势力", "文明", "由来", "传说", "秘闻"],
    "aftermath":   ["结束", "收场", "善后", "清理", "整顿", "恢复", "收拾", "尘埃落定", "落幕", "尾声"],
    "humor":       ["搞笑", "逗", "笑", "颤抖", "离谱", "梗", "荒唐", "乐趣", "滑稽", "趣事"],
}
