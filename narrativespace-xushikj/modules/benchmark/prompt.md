...
读取 `.xushikj/config/methodology.yaml` 中的八大法则（极限铺垫原则、期待感管理系统、连锁震惊反应、角色基因锚定与弧光塑造、核心创作套路库、数据化质量评估原则、高智商压迫与期待感拉扯、降维打击与错位震惊），将其作为分析对标作品时的评估维度。
...
> **默认回答为否**：用户明确回答"否"，或已询问后用户沉默/未提供文本，方可视为选择"否"并跳过。
